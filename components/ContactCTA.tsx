      ...
      <div className="relative z-10 section-container">
        ...
        >
          <div className="glass-effect glass-border rounded-[40px] p-12 lg:p-16 text-center relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-[#285E4B]/5 to-[#378268]/5" />
            ...
            <motion.div
              ...
              className="absolute -top-20 -left-20 w-40 h-40 border border-[#285E4B]/20 rounded-full"
            />
            <motion.div
              animate={{
                rotate: -360,
              ...
              className="absolute -bottom-20 -right-20 w-40 h-40 border border-[#378268]/20 rounded-full"
            />
              ...
              >
                <Link href="#contact">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="btn-primary text-lg px-12 py-5 shadow-2xl shadow-[#285E4B]/40"
                  >
                    {t('scheduleCTA')}
                  </motion.button>
                </Link>
              ...
              >
                {[
                  ...
                  <div key={index} className="flex items-center gap-2">
                    <span className="text-[#378268]">{feature.icon}</span>
