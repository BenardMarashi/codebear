          ...
          <Link href="/" className="flex items-center gap-2 group flex-shrink-0">
            <div className="w-7 h-7 bg-white rounded-md flex items-center justify-center">
              <div className="grid grid-cols-2 gap-[2px] w-4 h-4">
                <div className="bg-[#285E4B] rounded-sm"></div>
                <div className="bg-[#378268] rounded-sm"></div>
                <div className="bg-[#378268] rounded-sm"></div>
                <div className="bg-[#285E4B] rounded-sm"></div>
              </div>
            </div>
          ...
          <div className="hidden md:flex items-center flex-shrink-0">
            <a href="#contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 bg-[#285E4B] border border-white/10 text-white text-sm font-medium rounded-lg hover:bg-[#193A2E] hover:shadow-lg hover:shadow-[#285E4B]/30 transition-all flex items-center gap-2"
              >
                <svg 
                  width="20" 
                  height="20" 
