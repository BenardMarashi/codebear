      ...
      {plan.popular && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
          <div 
            ...
            style={{
              background: 'linear-gradient(135deg, #285E4B 0%, #378268 100%)',
            }}
          >
            {t('popular')}
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-baseline gap-2 mb-4">
            <span 
              ...
              style={{
                background: 'linear-gradient(135deg, #285E4B 0%, #378268 50%, #46A684 100%)',
      ...
      >
        ...
        >
          <p className="text-gray-400">
            {t('note')} <a href="#contact" className="hover:text-[#378268] underline transition-colors" style={{ color: '#285E4B' }}>{t('contactUs')}</a>
          </p>
        </motion.div>
      </motion.div>
    </section>
